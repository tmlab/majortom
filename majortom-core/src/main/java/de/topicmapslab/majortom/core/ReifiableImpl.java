...
public abstract class ReifiableImpl extends ConstructImpl implements IReifiable {
	...
	public Topic getReifier() {
		return (Topic) getTopicMap().getStore().doRead(this, TopicMapStoreParamterType.REIFICATION);
	}
	...
	public void setReifier(Topic reifier) throws ModelConstraintException {
		...
		getTopicMap().getStore().doModify(this, TopicMapStoreParamterType.REIFICATION, reifier);
	}
