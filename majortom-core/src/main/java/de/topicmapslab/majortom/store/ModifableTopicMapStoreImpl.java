 ...
 * 
 */
public abstract class ModifableTopicMapStoreImpl extends ReadOnlyTopicMapStoreImpl {
	 ...
	 *            the parent system
	 */
	public ModifableTopicMapStoreImpl(final ITopicMapSystem topicMapSystem) {
	 ...
	 * @param identifier
	 *            the identifier
	 * @return the topic to merge in the current one, <code>null</code> if no topic has to be merged
	 ...
	 * @param topic
	 *            the topic
	 * @return <code>true</code> if the topic is used as type, <code>false</code> otherwise
	 */
	 ...
	 * @param topic
	 *            the topic
	 * @return <code>true</code> if the topic is used as supertype, <code>false</code> otherwise
	 */
	 ...
	 * @param topic
	 *            the topic
	 * @return <code>true</code> if the topic is used as player, <code>false</code> otherwise
	 */
	 ...
	 * @param type
	 *            the type
	 * @return <code>true</code> if an association was removed, <code>false</code> otherwise.
	 * @throws TopicMapStoreException
	 *             thrown if operation fails
	 */
	 ...
	 * 
	 * @return <code>true</code> if this topic type exists, <code>false</code> otherwise
	 * @throws TopicMapStoreException
	 *             thrown if operation fails
	 */
	 ...
	 * 
	 * @param the
	 *            event type for the internal change set
	 * 
