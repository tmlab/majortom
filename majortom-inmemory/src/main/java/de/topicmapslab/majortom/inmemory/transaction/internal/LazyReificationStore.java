 ...
 * 
 */
public class LazyReificationStore extends VirtualReificationStore<InMemoryTransactionTopicMapStore> {
	 ...
	 *            the store
	 */
	public LazyReificationStore(InMemoryTransactionTopicMapStore store) {
		super(store);
	}
