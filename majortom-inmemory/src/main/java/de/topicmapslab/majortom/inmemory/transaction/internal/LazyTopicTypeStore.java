 ...
 * 
 */
public class LazyTopicTypeStore extends VirtualTopicTypeStore<InMemoryTransactionTopicMapStore> {

	/**
	 * @param store
	 */
	public LazyTopicTypeStore(InMemoryTransactionTopicMapStore store) {
		super(store);
	}
}
