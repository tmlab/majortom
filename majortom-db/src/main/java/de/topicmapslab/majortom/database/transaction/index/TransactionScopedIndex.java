 ...
 * 
 */
public class TransactionScopedIndex extends IndexImpl<TransactionTopicMapStore> implements IScopedIndex {
	 ...
	 *            the in-memory store
	 */
	public TransactionScopedIndex(TransactionTopicMapStore store) {
		super(store);
	}
