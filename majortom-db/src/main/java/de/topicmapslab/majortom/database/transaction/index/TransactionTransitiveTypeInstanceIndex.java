 ...
 * 
 */
public class TransactionTransitiveTypeInstanceIndex extends TransactionTypeInstanceIndex implements ITransitiveTypeInstanceIndex {

	/**
	 * constructor
	 * 
	 * @param store
	 *            the parent in-memory topic map store
	 */
