...
//			public static final String QUERY_SELECT_SUBTYPES_OF_TOPIC = QUERY_SELECT_DIRECT_SUBTYPES;
			...
			public static final String QUERY_SELECT_DIRECT_SUPERTYPES = "SELECT id_supertype AS id FROM rel_kind_of WHERE id_subtype = ? UNION SELECT DISTINCT id_player AS id FROM roles WHERE id_parent IN ( SELECT id FROM associations AS a WHERE a.id_type IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype-subtype' ) AND a.id IN ( SELECT id_parent FROM roles WHERE id_player = ? AND id_type IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE  l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/subtype' )))	AND id_type  IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE  l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype' );";
...
//			public static final String QUERY_SELECT_SUPERTYPES_OF_TOPIC = QUERY_SELECT_DIRECT_SUPERTYPES;
		...
		interface Paged {
			...
			public static final String QUERY_SELECT_DIRECT_SUPERTYPES = "SELECT id_supertype AS id FROM rel_kind_of WHERE id_subtype = ? UNION SELECT DISTINCT id_player AS id_supertype FROM roles WHERE id_parent IN ( SELECT id FROM associations AS a WHERE a.id_type IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype-subtype' ) AND a.id IN ( SELECT id_parent FROM roles WHERE id_player = ? AND id_type IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE  l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/subtype' )))	AND id_type  IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE  l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype' ) ORDER BY id OFFSET ? LIMIT ?;";

			public static final String QUERY_SELECT_SUPERTYPES = "SELECT id_supertype AS id  FROM rel_kind_of, topics WHERE id = id_subtype AND id_topicmap = ?  UNION SELECT DISTINCT id_player AS id FROM roles WHERE id_parent IN ( SELECT id FROM associations AS a WHERE a.id_type IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype-subtype' ))	AND id_type  IN ( SELECT id_topic FROM rel_subject_identifiers AS r, locators AS l WHERE  l.id = r.id_locator AND l.reference = 'http://psi.topicmaps.org/iso13250/model/supertype' ) AND id_topicmap =  ? ORDER BY id OFFSET ? LIMIT ?;";
