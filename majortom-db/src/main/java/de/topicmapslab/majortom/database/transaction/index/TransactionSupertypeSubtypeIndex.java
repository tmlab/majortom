 ...
 * 
 */
public class TransactionSupertypeSubtypeIndex extends IndexImpl<TransactionTopicMapStore> implements ISupertypeSubtypeIndex {
	 ...
	 *            the in-memory store
	 */
	public TransactionSupertypeSubtypeIndex(TransactionTopicMapStore store) {
		super(store);
	}
